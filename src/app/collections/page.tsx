...
const COLLECTIONS: CollectionDef[] = [
  ...
  },
  {
    id: "patios",
    emoji: "🍺",
    title: "Top Patios for Summer",
    description: "Bars and spots where people rave about the patio vibes.",
    query: { type: "category_and_post_contains", category: "bar", term: "patio" },
    linkParams: "?filter=bar&q=patio",
  },
  {
    id: "coffee",
    emoji: "☕",
  ...
  },
  {
    ...
    linkParams: "?filter=park",
  },
  {
    id: "new",
    emoji: "🆕",
    title: "New This Month",
    description: "Places that popped up on the radar in the last 30 days.",
  ...
  },
  {
    ...
    description: "The 5 most-talked-about places on BuzzMaps today.",
    query: { type: "top_by_mention", limit: 5 },
